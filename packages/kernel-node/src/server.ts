...
export async function buildServer() {
  ...
  app.log.info('🔗 Connecting to Python services...');
  ...
  app.log.info('📋 Registering REST routes...');
  ...
  app.log.info('🔌 Registering Connect RPC services...');
  ...
  app.log.info('✅ Colony OS Kernel configured');
...
async function main() {
  ...
  try {
    ...
    app.log.info('████████████████████████████████████████████████████████');
    app.log.info('█                                                      █');
    app.log.info('█   🐝 COLONY OS KERNEL - THE BODY 🐝                  █');
    app.log.info('█                                                      █');
    app.log.info('████████████████████████████████████████████████████████');
    app.log.info('');
...
process.on('SIGINT', async () => {
  console.log('\n🛑 Shutting down Colony OS Kernel...');
  await db.$disconnect();
  await redis.quit();
  process.exit(0);
});
